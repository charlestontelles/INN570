	...
	public static void main(String[] args) {
		try {
			...
			*/
	        ...
	        textsElement.addChildElement("string","", "http://schemas.microsoft.com/2003/10/Serialization/Arrays").addTextNode("Close");
	        textsElement.addChildElement("string","", "http://schemas.microsoft.com/2003/10/Serialization/Arrays").addTextNode("Do you want to save?");
	        textsElement.addChildElement("string","", "http://schemas.microsoft.com/2003/10/Serialization/Arrays").addTextNode("Birthday List");
	     ...
	     // POST the request
	        ClientResponse cr = service.header("SOAPAction", "\"http://api.microsofttranslator.com/V2/LanguageService/TranslateArray\"").header("Authorization",  "Bearer " + accessToken).post(ClientResponse.class, message);
