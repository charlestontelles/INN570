...
public class CopyOfBingAccess {
	...
	public static void main(String[] args) {
		try {
			...
			input.add("client_secret", "95vrnQVnBAyL7khBUlRQMGeJLQBQhfQbNqn+r5DJfGU=");
			...
			*/
	        ...
	        SOAPElement bodyElement = body.addChildElement(envelope.createName("GetLanguagesForTranslate", "", "http://api.microsofttranslator.com/V2"));
	        bodyElement.addChildElement("appId").addTextNode("");
	        message.saveChanges();
	        
			
	     // POST the request
	        ClientResponse cr = service.header("SOAPAction", "\"http://api.microsofttranslator.com/V2/LanguageService/GetLanguagesForTranslate\"").header("Authorization",  "Bearer " + accessToken).post(ClientResponse.class, message);
